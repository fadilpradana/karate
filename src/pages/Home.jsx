...
            const isDescriptionOnRight = index % 2 === 0;
...
                variants={{
                  hidden: { opacity: 0, x: isDescriptionOnRight ? -100 : 100 },
...
              >
                <div
                    className={`w-full md:w-1/2 h-60 flex items-center justify-center relative ${isDescriptionOnRight ? '' : 'md:order-last'}`}
...
          {/* Mengganti text-customPurple menjadi text-accent */}
          <h2 className="text-7xl font-league uppercase text-accent">
            Suara Sang Ksatria
          </h2>
          <h2 className="text-4xl font-league uppercase text-accent">
            Untuk Kemajuan Bersama
          </h2>
          <p className="mt-4 font-[Montserrat] font-light max-w-4xl mx-auto text-justify">
