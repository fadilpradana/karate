...
import { AlertTriangle } from 'lucide-react'; // Menggunakan AlertTriangle untuk error

// Komponen untuk menampilkan popup notifikasi error
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Judul Notifikasi */}
                <h2 className="text-4xl uppercase font-bold font-league text-red-500 mt-6">Gagal!</h2>
